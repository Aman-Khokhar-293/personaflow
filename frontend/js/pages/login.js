...
const LoginPage = {
        ...
        container.innerHTML = `
            <div class="auth-container">
                <div class="auth-card">
                    ...
                    <h2 class="auth-title">Welcome to PersonaFlow</h2>
                    <p class="auth-subtitle">Sign in to your account</p>

                    <!-- Social Login Buttons -->
                    <div class="auth-social-column">
                        <button class="social-btn premium-google-btn" title="Sign in with Google" type="button">
    ...
    setupListeners() {
        ...
        const googleBtn = document.querySelector('.social-btn[title="Sign in with Google"]');
        if (googleBtn) {
            googleBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    Toast.info('Connecting...', 'Logging in with Google...');
        ...
        const githubBtn = document.querySelector('.social-btn[title="Sign in with GitHub"]');
        if (githubBtn) {
            githubBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    Toast.info('Connecting...', 'Logging in with GitHub...');
                    const response = await API.post('/auth/google', { idToken });
                    Toast.success('Welcome back!', `Logged in as ${response.user.name}`);
                    App.login(response.user);
                } catch (error) {
    ...
    render(container) {
        ...
        document.getElementById('forgot-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                Toast.success('Check your email', 'If an account exists, we sent a reset link.');
            } catch (error) {
